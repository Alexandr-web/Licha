...
#### Accepted parameters
  ...
  * #### `ignoreNames`
    ...
    | Description | Example | Type |
    | ------------- | ------------- | ------------- |
    | Contains the names of the x-axis points that will not be drawn on the chart | `axisX: { ignoreNames: (name, index) => index % 2 === 0, }` or `axisX: { ignoreNames: ["Monday", "Sunday"], }` | `function: boolean \| array<string\|number>` |

  * #### `editName`

    | Description | Example | Type |
    | ------------- | ------------- | ------------- |
    | A method that allows you to change the appearance of a value along the x-axis | `axisX: { editName: (name) => new Date(name).toLocaleString(), }` | `function: string \| number` |
...
#### Accepted parameters
  ...
  * #### `color`
    ...
    | Description | Example | Type |
    | ------------- | ------------- | ------------- |
    | Cap color | `cap: { color: "red", }` | `array<string> \| string` |
...
#### Accepted parameters
  ...
  * #### `groups`
    ...
    * ##### `gaps`
      ...
      | Description | Example | Type |
      | ------------- | ------------- | ------------- |
      | Accepts data related to indentation of group names | `blockInfo: { padding: { right: 25, } }` | `object \| number` |
      ...
      * ###### `bottom`
        ...
        | Description | Example | Type |
        | ------------- | ------------- | ------------- |
        | Gap bottom | `blockInfo: { groups: { gaps: { bottom: 15, }, }, }` | `number` |

      * ###### `right`
          
        | Description | Example | Type |
        | ------------- | ------------- | ------------- |
        | Gap right | `blockInfo: { groups: { gaps: { right: 15, }, }, }` | `number` |
  ...
  * #### `title`
    ...
    * ##### `gaps`
      ...
      | Description | Example | Type |
      | ------------- | ------------- | ------------- |
      | Accepts data related to title padding | `blockInfo: { padding: { right: 25, } }` | `object \| number` |
  ...
  * #### Group
    ...
    * ##### `cap`
      ...
      * ###### `color`
        ...
        | Description | Example | Type |
        | ------------- | ------------- | ------------- |
        | Cap color | `data: { "My group": { cap: { color: "red" }, }, }` | `array<string> \| string` |
